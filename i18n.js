...
const UI_STRINGS = {
  en: {
    ...
    "hub.aria": "Modules",
    "hub.open": "Open",
    "hub.lessons.title": "Lessons",
    "hub.lessons.blurb": "Eight guided modules: dialogue, culture, pitfalls and practice.",
    "hub.flashcards.title": "Flashcards",
    "hub.flashcards.blurb": "Drill what you have met, in the language you are learning.",
    "hub.placement.title": "Placement",
    "hub.placement.blurb": "Not sure where to start? Answer a few questions.",
    "hub.library.title": "Library",
    "hub.library.blurb": "200 verbs and a fluency reference you can look things up in.",
    "hub.afterDark.title": "After Dark",
    "hub.afterDark.blurb": "Strong language, city by city, so you can understand what you hear.",
    "afterDark.eyebrow": "After Dark",
    "afterDark.title": "The language nobody teaches you.",
    "afterDark.lead": "Strong language you will hear in bars, taxis, stadiums and films. This is here so you can understand it and judge a room — never so you can aim it at anyone.",
    "afterDark.aria": "Cities",
    "afterDark.caution": "Severity is about the risk of repeating a phrase, not how rude it sounds. The same word can be a joke among friends and a fight between strangers, so when in doubt assume the harsher reading.",
    "afterDark.city.bogota": "Bogotá",
    "afterDark.city.medellin": "Medellín",
    "afterDark.city.barranquilla": "Barranquilla",
    "afterDark.note.bogota": "Bogotá (rolo). Insults here lean on class and manners, and strangers get less benefit of the doubt than in Medellín.",
    "afterDark.note.medellin": "Medellín (paisa). The harshest words double as greetings between close friends — a reading a visitor cannot borrow.",
    "afterDark.note.barranquilla": "Barranquilla (costeño). Coastal speech is louder and more profane on the surface, and often much less hostile underneath.",
    ...
    "deck.howTitle": "How to use these",
    "deck.how1": "Every card opens in the language you chose to learn. Change that choice at the top of the page and the cards turn around with it.",
    "deck.how2": "Answer out loud before you flip it. Pulling it out of memory is what makes it stick — recognising it once you see it does not.",
    "deck.how3": "Say you did not know it when you did not. Those cards come back later in the set; the ones you wave through do not.",
    "deck.how4": "Short and often beats long and once. A set is meant to be finished in one sitting.",
    ...
    "deck.ask.verb": "What does this verb mean?",
    "deck.ask.fluency": "What does this mean, and when would you use it?",
    ...
    "library.sourceNote.after": "; the level shown comes from it. The register label is a general guide — if one looks wrong, the Report an error tab is where corrections start.",
    ...
    "footer.note": "Regional usage varies across Colombia; treat every note as a starting point for listening, not a rule — and if something reads wrong to you, flag it where you found it.",
  ...
  es: {
    ...
    "nav.afterDark": "Después del anochecer",
    "nav.modules": "Módulos",
    "hub.aria": "Módulos",
    "hub.open": "Abrir",
    "hub.lessons.title": "Lecciones",
    "hub.lessons.blurb": "Ocho módulos guiados: diálogo, cultura, trampas y práctica.",
    "hub.flashcards.title": "Tarjetas",
    "hub.flashcards.blurb": "Repasa lo que ya viste, en el idioma que estás aprendiendo.",
    "hub.placement.title": "Nivel",
    "hub.placement.blurb": "¿No sabes por dónde empezar? Responde unas preguntas.",
    "hub.library.title": "Biblioteca",
    "hub.library.blurb": "200 verbos y una referencia de fluidez para consultar.",
    "hub.afterDark.title": "Después del anochecer",
    "hub.afterDark.blurb": "Lenguaje fuerte, ciudad por ciudad, para que entiendas lo que oyes.",
    "afterDark.eyebrow": "Después del anochecer",
    "afterDark.title": "El idioma que nadie te enseña.",
    "afterDark.lead": "Lenguaje fuerte que vas a oír en bares, taxis, estadios y películas. Está aquí para que lo entiendas y sepas leer el ambiente, nunca para que se lo digas a alguien.",
    "afterDark.aria": "Ciudades",
    "afterDark.caution": "La intensidad mide el riesgo de repetir la frase, no lo grosera que suena. La misma palabra puede ser un chiste entre amigos y una pelea entre desconocidos; ante la duda, asume la lectura más fuerte.",
    "afterDark.city.bogota": "Bogotá",
    "afterDark.city.medellin": "Medellín",
    "afterDark.city.barranquilla": "Barranquilla",
    "afterDark.note.bogota": "Bogotá (rolo). Los insultos aquí van por clase y modales, y a un desconocido se le perdona menos que en Medellín.",
    "afterDark.note.medellin": "Medellín (paisa). Las palabras más duras también sirven de saludo entre amigos cercanos: una lectura que un visitante no puede tomar prestada.",
    "afterDark.note.barranquilla": "Barranquilla (costeño). El habla costeña suena más fuerte y más grosera por fuera, y muchas veces es bastante menos hostil por dentro.",
    ...
    "deck.howTitle": "Cómo usarlas",
    "deck.how1": "Cada tarjeta empieza en el idioma que elegiste aprender. Cambia esa opción arriba de la página y las tarjetas se voltean contigo.",
    "deck.how2": "Responde en voz alta antes de voltearla. Lo que fija la memoria es sacarla de la cabeza; reconocerla cuando ya la ves, no.",
    "deck.how3": "Di que no la sabías cuando no la sepas. Esas tarjetas vuelven más adelante en la serie; las que dejas pasar, no.",
    "deck.how4": "Poco y seguido rinde más que mucho de una vez. Una serie está pensada para terminarse de una sentada.",
    ...
    "deck.ask.verb": "¿Qué significa este verbo?",
    "deck.ask.fluency": "¿Qué significa, y cuándo la usarías?",
    ...
    "library.sourceNote.after": "; de ahí sale el nivel que ves. La etiqueta de registro es una guía general; si algo no te cuadra, la pestaña Reportar un error es por donde empiezan las correcciones.",
    ...
    "footer.note": "El uso regional cambia por toda Colombia; toma cada nota como un punto de partida para escuchar, no como una regla — y si algo te suena mal, márcalo donde lo encontraste.",
