...
const UI_STRINGS = {
  en: {
    ...
    "deck.theme.shopping-and-money": "Shopping and money",
    "deck.theme.transport-and-travel": "Transport and travel",
    "deck.theme.health-and-body": "Health and the body",
    "deck.theme.work-and-employment": "Work",
    "deck.theme.study-and-academia": "Study",
    "deck.theme.civic-and-services": "Paperwork and services",
    "deck.theme.plans-and-time": "Plans and time",
    ...
    "deck.meta.lexicon": "{count} words the lessons use but never repeat",
    ...
    "deck.ask.lexicon": "Say the word — and if it is a noun, say it with its article.",
    ...
    "deck.label.due": "{label} · {due} due",

    "deck.typedLabel": "Type the answer",
    "deck.typedPrompt": "Write it from memory",
    "deck.typedCheck": "Check",
    "deck.typed.exact": "Exact.",
    "deck.typed.accent": "Right word — the accents go like this: {expected}",
    "deck.typed.article": "Close enough. The card says: {expected}",
    "deck.typed.typo": "A typo, but you knew it: {expected}",
    "deck.typed.enye": "Not quite — that ñ changes the word. It's {expected}",
    "deck.typed.enyeClose": "Right word — it needs the ñ: {expected}",
    "deck.typed.wrong": "Not this one. It's {expected}",
    "deck.typed.empty": "Nothing typed yet.",
    "deck.typed.unavailable": "This card is too long to type. Flip it instead.",
    ...
    "mature.unverified": "No Colombian native speaker has checked these entries yet. How strong a word lands varies by region, company and tone, so treat the severity labels as a rough guide rather than a measurement.",
    ...
    "provenance.machine": "The Spanish explanations in this lesson were written by machine and have not yet been checked by a native speaker.",
  ...
  es: {
    ...
    "deck.topic.lexicon": "Palabras · {level}",
    "deck.topic.fluency": "Conectores y atenuantes",
    "deck.topic.slang": "Jerga · {level}",
    ...
    "deck.theme.shopping-and-money": "Compras y plata",
    "deck.theme.transport-and-travel": "Transporte y viajes",
    "deck.theme.health-and-body": "Salud y cuerpo",
    "deck.theme.work-and-employment": "Trabajo",
    "deck.theme.study-and-academia": "Estudio",
    "deck.theme.civic-and-services": "Trámites y servicios",
    "deck.theme.plans-and-time": "Planes y tiempo",
    ...
    "deck.meta.lexicon": "{count} palabras que las lecciones usan pero no repiten",
    ...
    "deck.ask.lexicon": "Di la palabra; si es sustantivo, dila con su artículo.",
    ...
    "deck.label.due": "{label} · {due} por repasar",

    "deck.typedLabel": "Escribir la respuesta",
    "deck.typedPrompt": "Escríbalo de memoria",
    "deck.typedCheck": "Revisar",
    "deck.typed.exact": "Exacto.",
    "deck.typed.accent": "La palabra está bien; las tildes van así: {expected}",
    "deck.typed.article": "Vale. La tarjeta dice: {expected}",
    "deck.typed.typo": "Un error de dedo, pero sí sabía: {expected}",
    "deck.typed.enye": "Casi — esa ñ cambia la palabra. Es {expected}",
    "deck.typed.enyeClose": "La palabra está bien; le falta la ñ: {expected}",
    "deck.typed.wrong": "No es esa. Es {expected}",
    "deck.typed.empty": "Todavía no ha escrito nada.",
    "deck.typed.unavailable": "Esta tarjeta es muy larga para escribirla. Mejor voltéela.",
    ...
    "library.slangUnverified": "Ningún hablante nativo colombiano ha revisado estas entradas todavía. Los significados y las etiquetas regionales son un punto de partida para escuchar, no una regla establecida.",
    ...
    "mature.unverified": "Ningún hablante nativo colombiano ha revisado estas entradas todavía. La fuerza de una palabra cambia según la región, la confianza y el tono, así que toma las etiquetas de intensidad como una guía aproximada, no como una medida.",
    ...
    "provenance.machine": "Las explicaciones en español de esta lección las escribió una máquina y todavía no las ha revisado un hablante nativo.",
