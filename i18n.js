...
const UI_STRINGS = {
  en: {
    ...
    "hub.aria": "Modules",
    "hub.open": "Open",
    "hub.path.title": "Your path",
    "hub.path.blurb": "The whole course in order: four stages, {modules} modules, {lessons} lessons. Start here.",
    ...
    "path.title": "One path, four stages.",
    "path.lead": "Work top to bottom. Each module teaches one verb or one structure, and each stage takes you to the next level of the scale. You can wander off into any lesson you like — this is the order that builds.",
  ...
  es: {
    ...
    "hub.aria": "Módulos",
    "hub.open": "Abrir",
    "hub.path.title": "Tu ruta",
    "hub.path.blurb": "El curso completo en orden: cuatro etapas, {modules} módulos, {lessons} lecciones. Empieza aquí.",
    ...
    "path.title": "Un camino, cuatro etapas.",
    "path.lead": "Avanza de arriba abajo. Cada módulo enseña un verbo o una estructura, y cada etapa te lleva al siguiente nivel de la escala. Puedes desviarte a la lección que quieras: este es el orden que construye.",
