...
lessons.push(
  {
    ...
    es: {
      ...
      setting: {
        ...
        when: "Late Sunday night, after the final whistle, while horns, music, and post-match arguments are still moving through the neighbourhood.",
        where: "Cali, outside a small restaurant near San Fernando, using football without turning the lesson into a children's game.",
      ...
      address: {
        ...
        ifYouSwitch:
          "Tú would be understood but would flatten the Caleño flavour. Usted would sound like sudden distance or a pointed joke between friends."
      },
      dialogue: [
      ...
      vocabulary: [
        dl28Vocab("ganar", "The core verb for winning a contest, result, vote, argument, or match where a winner can be named.", "to win", "Use it when the outcome has a winner, even if the prize is only bragging rights after a tense final.", "Avoid it for simple buying, receiving, or getting with no contest, labour, merit, or measured result.", "neutral", "General Spanish, with Colombian school uses worth learning separately.", ["vencer", "triunfar", "empatar", "perder"], "Hoy ganamos bien.", "Today we won fairly."),
        dl28Vocab("ganarse", "The form used when someone earns something less tangible, especially respect, trust, affection, or a reputation.", "to win for oneself", "Use it when behaviour over time produces a reaction from other people.", "Avoid it when you are simply reporting the final score; a team gana, but a coach se gana respeto.", "neutral", "General Spanish and very common in Colombian speech.", ["merecer", "lograr", "conseguir", "hacerse a"], "El técnico se ganó el respeto.", "The coach earned respect."),
      ...
      culture: [
        dl28Culture("Football without childishness", "Football belongs to adults across Colombia. In Cali, América and Deportivo Cali carry family histories, neighbourhood loyalties, and long memories. The teasing can be sharp, but good friends still leave room for the other person to save face."),
        ...
        dl28Culture("Respect is earned slowly", "Se ganó el respeto is stronger than people liked him. It suggests that pressure changed how others judged him. Colombians use it for teachers, coaches, neighbours, and anyone who proved themselves when it mattered.")
      ],
      pitfalls: [
        ...
        dl28Pitfall("Assuming ganar bien always means earn good money", "It can mean earning well, but in a match conversation it defends the quality or fairness of the win. Context decides which sense is alive.", "In football, ganamos bien means we won fairly or deservedly.")
      ],
      variations: [
      ...
      practiceExtra: [
        ...
        dl28Question("Which sentence best fits a deserved football result?", ["Ganamos bien, sin regalo.", "Ganamos plata, sin salario.", "Ganamos el año, sin colegio."], 0, "ganar bien in a match context"),
    ...
    en: {
      ...
      situation:
        "Usted está en una conversación de fútbol en Toronto después de una final local. Su equipo ganó, pero también necesita hablar de plata, respeto y de pasar el año escolar sin traducir todo con una sola palabra.",
      setting: {
        ...
        where: "Toronto, en un restaurante pequeño del barrio, con la conversación llevada al inglés por la mezcla de amigos.",
      ...
      variations: [
        dl28Variation("We won fair today.", "friendly informal", "Inglés conversacional", "Para defender una victoria limpia entre amigos."),
        dl28Variation("The club earns good money from a final.", "neutral", "Inglés universal", "Cuando el tema son ingresos y no el marcador."),
        dl28Variation("He earned everyone's respect.", "neutral", "Inglés universal", "Alguien probó su valor con hechos."),
        dl28Variation("He passed the year by the skin of his teeth.", "friendly informal", "Inglés universal", "Un estudiante pasó raspando."),
        dl28Variation("Don't act like you walked it.", "friendly informal", "Inglés conversacional", "Para negar que una victoria haya sido fácil.")
      ],
  ...
  },
  {
    ...
    es: {
      ...
      vocabulary: [
        ...
        dl28Vocab("la cédula", "The Colombian national ID card. Losing it can block errands, appointments, voting, and official checks.", "the ID card", "Use it for Colombian identity-document situations, from clinics to banks to elections.", "Avoid it for a passport or foreign driver's licence; those documents have their own names.", "neutral", "Colombia.", ["documento", "identificación", "tarjeta", "registro"], "Se me perdió la cédula.", "My ID got lost on me."),
      ...
      culture: [
        ...
        dl28Culture("Bucaramanga without fake slang", "The scene uses plain Colombian Spanish because accurate plain language beats invented regional colour. The city matters through the route, the appointment, and the pressure, not through a forced catchphrase.")
      ],
      pitfalls: [
    ...
    en: {
      ...
      setting: {
        ...
        where: "Una parada de bus en una ciudad canadiense, con la presión práctica parecida a la de una mañana en Bucaramanga.",
      ...
      culture: [
        dl28Culture("El documento cambia de nombre", "Cédula no viaja sola al inglés. Según el país, usted dirá ID, national ID card, driver's licence o passport. ID es la opción amplia cuando el tipo exacto no importa."),
      ...
      variations: [
        dl28Variation("My ID went missing.", "neutral", "Inglés universal", "Quiere acercarse al tono accidental de se me perdió."),
  ...
  },
  {
    ...
    es: {
      ...
      setting: {
        who: "Camila volunteers at a neighbourhood forum, and Don Álvaro is a resident who asks sharp but fair questions.",
        ...
        where: "Pereira, in a community hall near the centre, bringing the Eje Cafetero into the catalogue.",
      ...
      address: {
        ...
        why: "The subject is civic and the room includes neighbours of different ages. Usted keeps disagreement respectful without making it cold.",
        ifYouSwitch:
      ...
      vocabulary: [
        dl28Vocab("elegir", "To choose with weight, and to elect someone to a position. It is common, but often more formal than escoger.", "to choose / elect", "Use it when the choice is deliberate, public, official, or about a person taking a role.", "Avoid it for casually picking food, a seat, or a colour; Colombians often say escoger there.", "neutral to formal", "General Spanish; the elegir versus escoger split is very useful in Colombia.", ["escoger", "votar", "seleccionar", "decidir"], "La comunidad lo elige.", "The community elects him."),
        dl28Vocab("escoger", "The more common everyday spoken verb for picking among options, with less official weight than elegir.", "to pick / choose", "Use it for menus, seats, colours, routes, and ordinary options where nobody is being elected.", "Avoid it when the choice is an office, a representative, or a formal process where elegir may fit better.", "neutral conversational", "Very common Colombian Spanish.", ["elegir", "seleccionar", "preferir", "quedarse con"], "Se escoge entre opciones reales.", "You pick among real options."),
      ...
      pitfalls: [
        dl28Pitfall("Using elegir for every tiny choice", "It is grammatical, but it can sound too formal for snacks, seats, or colours. In speech, Colombians often reach for escoger in those ordinary moments.", "Use escoger for casual picking and elegir for weightier choices."),
    ...
    en: {
      ...
      variations: [
        dl28Variation("Choose carefully.", "neutral", "Inglés universal", "Quiere pedir una decisión pensada."),
        dl28Variation("Pick from real options.", "friendly informal", "Inglés universal", "Está hablando de escoger entre opciones prácticas."),
        dl28Variation("Vote for a candidate.", "neutral civic", "Inglés universal", "Nombra el acto de votar."),
        dl28Variation("The community elects him.", "formal civic", "Inglés universal", "Un grupo lo pone en un cargo."),
        dl28Variation("Choose the one who can answer for the job.", "neutral", "Inglés universal", "Quiere combinar decisión personal y responsabilidad.")
      ],
