...
lessons.push(
  {
    ...
    en: {
      ...
      vocabulary: [
        dl60Vocab("stop", "Parar o detenerse. Es el verbo básico para un taxi, bus, máquina o movimiento.", "parar", "Úselo para pedir una parada, decir que algo se detuvo o terminar una acción.", "Evítelo para pararse de una silla. Ahí necesita stand up.", "neutro", "Inglés universal.", ["pull over", "halt", "pause", "stop at"], "Could you stop at the corner?", "¿Me para en la esquina?"),
        dl60Vocab("stop here", "Pare aquí. Frase corta y directa para un punto inmediato.", "pare aquí", "Úselo cuando el lugar ya llegó y necesita claridad rápida.", "Evítelo si necesita sonar más suave y hay tiempo. Could you stop here, please? suena mejor.", "práctico imperativo", "Inglés universal.", ["pull over here", "right here", "drop me here", "here is fine"], "Stop here, please.", "Pare aquí, por favor."),
        dl60Vocab("pull over", "Arrimarse o parar a un lado con un vehículo.", "halar hacia un lado", "Úselo con carros, taxis y policías cuando el vehículo debe ir a la orilla.", "Evítelo para una persona que se pone de pie o para una máquina que se apaga.", "neutro práctico", "Inglés universal.", ["stop by the curb", "pull in", "park briefly", "drop off"], "Pull over after the light.", "Pare después del semáforo."),
        dl60Vocab("nonstop", "Sin parar. Describe algo continuo, sin pausa.", "sin parada", "Úselo para lluvia, llamadas, trabajo, ruido, viajes o mensajes continuos.", "Evítelo como traducción de una orden. Nonstop is a description, not a command.", "neutro", "Inglés universal.", ["constantly", "continuously", "without stopping", "all the time"], "It rang nonstop.", "Sonó sin parar."),
        dl60Vocab("stand up", "Pararse o ponerse de pie. Es postura, no detenerse.", "estar de pie arriba", "Úselo cuando alguien se levanta de una silla, cama, banca o asiento.", "Evítelo para un taxi que se detiene. The taxi stops; a person stands up.", "neutro", "Inglés universal.", ["get up", "rise", "be standing", "sit down"], "I'll stand up for a second.", "Me paro un segundo."),
        dl60Vocab("pay attention", "Prestar atención o parar bolas en registro informal colombiano.", "pagar atención", "Úselo cuando alguien debe fijarse en un aviso, instrucción, riesgo o detalle.", "Evítelo si quiere sonar muy colombiano en español. Pay attention is neutral English, not an idiom with balls.", "neutro", "Inglés universal.", ["notice", "watch", "focus", "listen carefully"], "Pay attention to the blue gate.", "Párele bolas al portón azul."),
        dl60Vocab("drop me off", "Dejarme o bajarme en un lugar. A veces suena más natural que stop.", "dejarme caer", "Úselo cuando el foco es dónde termina el viaje para el pasajero.", "Evítelo si usted sólo quiere que el carro pare un momento sin bajarse.", "neutro conversacional", "Inglés universal.", ["let me out", "stop for me", "leave me", "pull over"], "Drop me off at the corner.", "Déjeme en la esquina.")
      ],
      note:
      ...
      variations: [
        dl60Variation("Could you stop at the corner?", "cortés práctico", "Inglés universal", "Pide la parada del taxi."),
        dl60Variation("Pull over after the light.", "práctico", "Inglés universal", "El carro debe arrimarse al lado."),
        dl60Variation("It rained nonstop.", "neutro", "Inglés universal", "Algo siguió sin parar."),
        dl60Variation("I'll stand up for a second.", "neutro", "Inglés universal", "Una persona se levanta."),
        dl60Variation("Pay attention to the blue gate.", "neutro", "Inglés universal", "Traduce parar bolas sin copiar la imagen.")
      ],
  ...
  },
  {
    ...
    en: {
      ...
      vocabulary: [
        dl60Vocab("cause", "Causar. Es directo y sirve muy bien para daños, retrasos, ruido y problemas.", "causar", "Úselo cuando una cosa produce una consecuencia concreta o explicable.", "Evítelo como traducción automática de todos los me dio. A veces made me or gave me sounds better.", "neutro a formal", "Inglés universal.", ["lead to", "create", "bring about", "produce"], "That caused a huge delay.", "Eso causó un retraso enorme."),
        dl60Vocab("cause damage", "Causar daño. Colocación normal en reportes, garantías y quejas.", "causar daño", "Úselo cuando algo dañó una máquina, objeto, lugar o proceso.", "Evítelo si sólo hubo molestia o atraso; name the effect more exactly.", "formal práctico", "Inglés universal.", ["damage", "harm", "break", "affect"], "Grease caused damage.", "La grasa causó daño."),
        dl60Vocab("cause problems", "Causar problemas. Más amplio que damage y útil para retrasos o complicaciones.", "causar problemas", "Úselo cuando la consecuencia es una dificultad general.", "Evítelo si puede nombrar delay, noise, overheating or shutdown. Specific nouns help.", "neutro", "Inglés universal.", ["create problems", "lead to trouble", "complicate things", "disrupt"], "It caused problems all morning.", "Causó problemas toda la mañana."),
        dl60Vocab("make an impression", "Causar impresión. Algo deja una marca mental o emocional.", "hacer una impresión", "Úselo cuando algo sorprende, impacta o se queda en la memoria.", "Evítelo para sustos comunes. Gave me a scare or scared me sounds more natural.", "neutro", "Inglés universal.", ["impress", "strike", "stay with", "affect"], "It made a big impression.", "Me causó mucha impresión."),
        dl60Vocab("give me a scare", "Darme un susto. Natural para miedo repentino o alarma cotidiana.", "darme un susto", "Úselo cuando algo lo asusta por un momento.", "Evítelo en reportes técnicos. Caused alarm or presented a risk may be more formal.", "amistoso informal", "Inglés universal.", ["scare me", "frighten me", "startle me", "make me nervous"], "It gave me a scare.", "Me dio susto."),
        dl60Vocab("make me laugh", "Darme risa o hacerme reír. Frase cotidiana para una reacción de risa.", "hacerme reír", "Úselo cuando algo provoca risa naturalmente.", "Evítelo como cause me laughter in conversation. That sounds stiff or comic.", "amistoso informal", "Inglés universal.", ["make me smile", "crack me up", "amuse me", "be funny"], "That made me laugh.", "Eso me dio risa."),
        dl60Vocab("lead to", "Llevar a o producir como consecuencia. Más suave que cause en algunos informes.", "llevar a", "Úselo para cadenas de consecuencias donde una cosa termina en otra.", "Evítelo si necesita nombrar una causa directa y fuerte. Cause may be clearer.", "neutro", "Inglés universal.", ["cause", "result in", "bring about", "produce"], "The grease led to overheating.", "La grasa causó calentamiento.")
      ],
      note:
      ...
      variations: [
        dl60Variation("That caused a huge delay.", "formal práctico", "Inglés universal", "Una causa produjo un atraso concreto."),
        dl60Variation("Grease caused damage.", "técnico", "Inglés universal", "Explica una falla o daño."),
        dl60Variation("It made a big impression.", "neutro", "Inglés universal", "Algo impactó o marcó a alguien."),
        dl60Variation("It gave me a scare.", "amistoso informal", "Inglés universal", "Cuenta un susto cotidiano."),
        dl60Variation("That made me laugh.", "amistoso informal", "Inglés universal", "Traduce me dio risa naturalmente."),
        {
  ...
  },
  {
    ...
    en: {
      ...
      vocabulary: [
        dl60Vocab("produce", "Producir. Sirve para crear algo o generar un efecto, pero puede sonar formal.", "producir", "Úselo para informes, resultados, evidencia, alivio, daño o producción real.", "Evítelo si cause, lead to or make suena más natural en conversación.", "neutro a formal", "Inglés universal.", ["create", "generate", "cause", "bring about"], "The storm produced flooding.", "La tormenta produjo inundaciones."),
        dl60Vocab("produced", "Produjo o produjeron según el sujeto. En inglés es regular; en español el pasado es irregular.", "produjo / produjeron", "Úselo para efectos terminados en el pasado.", "Evítelo como guía para conjugar español. Produced no revela la raíz -duj- de produjo.", "neutro", "Inglés universal.", ["caused", "generated", "led to", "resulted in"], "It produced small floods.", "Produjo inundaciones pequeñas."),
        dl60Vocab("lead to", "Llevar a o producir una consecuencia. Muy natural para cierres, cambios y resultados.", "llevar a", "Úselo cuando una causa termina en una consecuencia identificable.", "Evítelo si quiere decir crear un objeto físico o un informe. Produce fits there.", "neutro explanatory", "Inglés universal.", ["result in", "cause", "bring about", "end in"], "The damage led to closure.", "El daño produjo el cierre."),
        ...
        dl60Vocab("produce a report", "Producir un informe: preparar y entregar un documento.", "producir un informe", "Úselo para documentos, videos, plans, evidence and official materials.", "Evítelo para mandar un mensaje breve. Write or send a message sounds more natural.", "formal práctico", "Inglés universal.", ["write a report", "prepare a report", "issue a report", "compile evidence"], "We'll produce a full report.", "Produciremos un informe completo."),
        dl60Vocab("relief", "Alivio. Puede ser emocional o práctico, como bajar presión o reducir daño.", "alivio", "Úselo cuando una medida mejora la situación o reduce un problema.", "Evítelo si la mejora es muy informal y personal; helped may say it more simply.", "neutro", "Inglés universal.", ["help", "improvement", "easing", "reduction"], "The pumps produced relief.", "Las bombas produjeron alivio."),
        dl60Vocab("the -duj- stem", "La raíz irregular de produjo, produjeron, tradujo, condujo y redujo.", "la raíz -duj-", "Úselo como recordatorio gramatical para el pasado español de verbos en -ducir.", "Evítelo como regla para el inglés. English produced stays regular.", "de gramática nota", "Spanish grammar explained in English class.", ["produjo", "produjeron", "tradujo", "condujo"], "Produjo uses the -duj- stem.", "Produjo usa la raíz -duj-.")
      ],
      note:
      ...
      variations: [
        dl60Variation("The storm produced flooding.", "informativo explanatory", "Inglés universal", "Un evento generó un efecto."),
        dl60Variation("The works produced more mud.", "informativo conversacional", "Inglés universal", "Unas obras generaron un resultado concreto."),
        dl60Variation("The damage led to the road closure.", "neutro explanatory", "Inglés universal", "Una causa terminó en una consecuencia."),
        dl60Variation("We'll produce a full report.", "formal práctico", "Inglés universal", "Un equipo preparará un documento."),
        dl60Variation("Produjo uses the -duj- stem.", "de gramática nota", "Inglés para gramática española", "Recordar la irregularidad al volver al español.")
      ],
