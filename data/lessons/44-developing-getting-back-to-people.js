...
lessons.push(
  {
    ...
    en: {
      ...
      vocabulary: [
        dl44Vocab("answer", "Contestar una llamada, una pregunta o una puerta. Es el verbo más directo para decir que hubo respuesta básica.", "contestar", "Úselo con phone, question, door, call y situaciones donde importa si alguien respondió o no.", "Evítelo si quiere hablar de una respuesta escrita específica; reply puede sonar más preciso.", "neutral", "Inglés universal.", ["reply", "respond", "pick up", "call back"], "She didn't answer the phone.", "No contestó el teléfono."),
        dl44Vocab("answer the phone", "Contestar el teléfono. Es frase fija y natural.", "contestar el teléfono", "Úselo cuando alguien recoge una llamada o no la recoge.", "Evítelo como respond the phone. Esa frase suena incorrecta en inglés cotidiano.", "neutral", "Inglés universal.", ["pick up", "take the call", "call back", "miss the call"], "Answer the phone, please.", "Contesta el teléfono, por favor."),
        dl44Vocab("reply", "Responder o contestar un mensaje, correo o comentario. En chat suele ser más preciso que answer.", "contestar / responder", "Úselo para textos, correos, mensajes de voz, comentarios y conversaciones escritas.", "Evítelo con puertas y teléfonos si habla de recoger la llamada; answer fits better there.", "neutral", "Inglés universal.", ["answer", "write back", "text back", "respond"], "She never replied.", "Nunca contestó."),
        dl44Vocab("leave someone on read", "Dejar a alguien en visto: leer el mensaje y no contestar.", "dejar en leído", "Úselo cuando la aplicación muestra que la otra persona vio el mensaje.", "Evítelo para llamadas, cartas o situaciones sin confirmación de lectura.", "friendly informal", "Inglés digital.", ["read receipt", "ignore", "not reply", "seen"], "She left me on read.", "Me dejó en visto."),
        dl44Vocab("respond", "Responder de manera más considerada, formal o completa que un simple answer.", "responder", "Úselo para comunicados, preguntas serias, crisis, críticas o respuestas pensadas.", "Evítelo con phone como objeto directo. No se dice respond the phone.", "neutral", "Inglés universal.", ["reply", "answer", "react", "address"], "She responded carefully.", "Respondió con cuidado."),
        dl44Vocab("still nothing", "Todavía nada. Sirve para decir que no ha llegado ninguna respuesta.", "todavía nada", "Úselo cuando alguien pregunta si hubo noticias, respuesta o movimiento.", "Evítelo en informes formales, donde conviene una frase completa.", "friendly informal", "Inglés universal.", ["no news", "nothing yet", "no answer", "no reply"], "Still nothing from Lina.", "Todavía nada de Lina."),
        dl44Vocab("reply late", "Contestar tarde, cuando la respuesta llega después de lo útil o lo cortés.", "responder tarde", "Úselo cuando la respuesta sí llega, pero la demora cambia el plan o el ánimo.", "Evítelo si nunca llegó respuesta. Entonces use never replied or didn't answer.", "neutral", "Inglés universal.", ["answer late", "text back late", "get back late", "respond late"], "If she replies late, tell her.", "Si contesta tarde, dígale.")
      ],
      note:
      ...
      variations: [
        dl44Variation("Did Lina answer you?", "friendly informal", "Inglés universal", "Pregunta si Lina contestó de alguna manera."),
  ...
  },
  {
    ...
    en: {
      ...
      vocabulary: [
        dl44Vocab("let me know", "La traducción más útil de avísame o avíseme en planes cotidianos.", "déjeme saber", "Úselo para llegadas, cambios de plan, decisiones pendientes y actualizaciones simples.", "Evítelo si necesita un aviso formal legal o institucional; notify puede ser más apropiado.", "neutral warm", "Inglés universal.", ["tell me", "update me", "keep me posted", "give me a heads-up"], "Let me know when you arrive.", "Avíseme cuando llegue."),
        dl44Vocab("I'll let you know", "Yo te aviso o yo le aviso. Puede ser una promesa real o una forma suave de aplazar.", "le dejaré saber", "Úselo cuando de verdad va a revisar algo y contestar después.", "Evítelo como sustituto de un sí firme. Puede sonar a maybe if no time or detail follows.", "neutral conversational", "Inglés universal.", ["I'll tell you", "I'll update you", "I'll get back to you", "I'll keep you posted"], "I'll let you know when I get there.", "Le aviso cuando llegue."),
        dl44Vocab("tell me", "Dígame o dime. Es más directo que let me know y pide una información concreta.", "dígame", "Úselo cuando la decisión ya puede darse: dónde, cuándo, cuál opción o qué pasó.", "Evítelo si quiere sonar más suave y abierto. Let me know gives more room.", "neutral", "Inglés universal.", ["let me know", "say", "explain", "confirm"], "Tell me if you want lunch.", "Dígame si quiere almorzar."),
      ...
      variations: [
        dl44Variation("Let me know when you arrive.", "neutral warm", "Inglés universal", "Pedir un aviso de llegada."),
        dl44Variation("I'll let you know as soon as I know.", "neutral conversational", "Inglés universal", "Promete actualizar cuando tenga información."),
        dl44Variation("Tell me if you want lunch.", "neutral", "Inglés universal", "Pide una decisión concreta."),
        dl44Variation("I'll give you a heads-up.", "friendly informal", "Inglés universal", "Avisará con anticipación para evitar sorpresa."),
        dl44Variation("Don't count on me yet.", "neutral direct", "Inglés universal", "Aclara que el plan no debe depender de usted.")
      ],
  ...
  },
  {
    ...
    en: {
      ...
      vocabulary: [
        ...
        dl44Vocab("I promise I'll", "Le prometo que o prometo que. Muy útil para nombrar la acción concreta.", "prometo que yo", "Úselo con una acción medible: text, call, email, arrive, pay, send.", "Evítelo con resultados fuera de su control. La estructura suena firme.", "neutral", "Inglés universal.", ["I promise to", "I'll make sure", "I commit to", "I give my word"], "I promise I'll text before noon.", "Prometo escribir antes del mediodía."),
        dl44Vocab("keep a promise", "Cumplir una promesa. Es la colocación normal en conversación.", "guardar una promesa", "Úselo para decir que alguien cumplió o rompió su palabra.", "Evítelo como fulfill a promise en habla casual si quiere sonar natural.", "neutral", "Inglés universal.", ["break a promise", "follow through", "keep your word", "come through"], "Promise only what you'll keep.", "Promete sólo lo que vas a cumplir."),
        dl44Vocab("I'll see", "Yo miro a ver. Frase suave que deja la decisión abierta.", "veré", "Úselo cuando necesita revisar o no quiere comprometerse todavía.", "Evítelo si la otra persona necesita una confirmación firme. Puede sonar evasivo.", "friendly informal", "Inglés universal.", ["I'll check", "I'll look into it", "maybe", "I'll let you know"], "I'll see and let you know.", "Miro a ver y te aviso."),
        dl44Vocab("I'll try", "Intentaré. Baja la expectativa y no promete el resultado.", "intentaré", "Úselo cuando quiere mostrar voluntad sin garantizar que algo pase.", "Evítelo si ya aceptó una responsabilidad clara. Puede sonar débil.", "neutral conversational", "Inglés universal.", ["I'll do my best", "I'll see what I can do", "I can't promise", "maybe"], "I'll try, but I can't promise.", "Intento, pero no prometo."),
        dl44Vocab("I mean it", "Lo digo en serio. Refuerza una promesa o una frase que pudo sonar vaga.", "lo significo", "Úselo para mostrar que esta vez no está hablando por salir del paso.", "Evítelo si no piensa cumplir. Sube la expectativa y puede empeorar el daño.", "neutral conversational", "Inglés universal.", ["seriously", "for real", "I promise", "no kidding"], "I mean it this time.", "Esta vez es en serio.")
      ],
      note:
      ...
      variations: [
        ...
        dl44Variation("I promise I'll text before noon.", "clear practical", "Inglés universal", "Compromiso medible y controlable."),
        dl44Variation("I'll keep my promise.", "neutral", "Inglés universal", "Habla de cumplir la palabra."),
        dl44Variation("I'll see and let you know.", "soft conversational", "Inglés universal", "Revisa primero y no promete todavía."),
