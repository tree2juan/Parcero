...
lessons.push(
  ...
  },
  {
    ...
    es: {
      ...
      setting: {
        who: "Don Álvaro runs a small laundry that also receives delicate items. Dana has been travelling through Santander and has damp clothes that cannot sit another night.",
        what: "A practical counter conversation about washing clothes, separating colours and asking whether the laundry can handle sneakers.",
        when: "Mid-afternoon after a humid morning, when many neighbours have decided their clothes will not dry at home.",
        where: "Bucaramanga, in a neighbourhood laundry near Cabecera, with fans running and plastic baskets stacked behind the counter.",
      ...
      dialogue: [
        ...
        },
        {
          ...
          translation: "Don't worry, that gets washed separately so it doesn't bleed colour.",
          pronunciation: "tran-KEE-la, EH-soh seh LAH-ba por seh-pah-RAH-doh PAH-ra keh no des-TEE-nyah",
          literal: "Calm, that itself washes by separated so that it does not bleed-colour.",
      ...
      vocabulary: [
        ...
        { term: "por separado", explanation: "Separately, especially to avoid colours running or delicate items getting damaged.", literal: "by separated", useWhen: "Giving instructions for white shirts, dark jeans, towels or delicate clothes.", avoidWhen: "There is no risk from mixing the items. Then it sounds fussy rather than careful.", register: "neutral", region: "General Spanish.", related: ["aparte", "junto", "mezclar", "desteñir"], example: { target: "Eso se lava por separado.", translation: "That gets washed separately." } },
        { term: "desteñir", explanation: "For fabric colour to bleed or fade into other clothes.", literal: "to un-dye", useWhen: "Explaining why dark jeans, new towels or bright shirts should not share a wash.", avoidWhen: "The problem is only a stain. A stain mancha; a colour destiñe.", register: "neutral", region: "General Spanish.", related: ["manchar", "teñir", "color", "ropa oscura"], example: { target: "Para que no destiña.", translation: "So it doesn't bleed colour." } },
      ...
      culture: [
        { label: "Neighbourhood laundries are instruction-heavy", body: "Small Colombian laundries often work through quick spoken instructions: what can be mixed, what must be separate, what time it will be ready. A customer who can say lavar, por separado and para mañana avoids both damage and awkward mime over a plastic basket." },
    ...
    en: {
      ...
      dialogue: [
        ...
        { speaker: "Clerk", target: "No worries, that gets washed separately so the colour doesn't run.", translation: "Tranquila, eso se lava por separado para que no destiña.", pronunciation: "nou UO-ris, dat gets uasht SE-pa-ret-li sou da CO-lor DA-sent ran", literal: "Sin preocupaciones, eso se lava separadamente para que el color no corra.", why: "Colour runs es la imagen inglesa normal para desteñir. No diga the colour destains; esa palabra no hace este trabajo en inglés corriente." },
      ...
      vocabulary: [
        ...
        { term: "the colour runs", explanation: "La manera natural de decir que una prenda destiñe y suelta color en el lavado.", literal: "el color corre", useWhen: "Advierte que jeans oscuros, toallas nuevas o camisetas fuertes pueden manchar otra ropa.", avoidWhen: "Habla de una mancha específica ya existente. Ahí necesita stain, no run.", register: "neutral", region: "Inglés universal; en Estados Unidos verá color sin u.", related: ["bleed", "fade", "stain", "dye"], example: { target: "So the colour doesn't run.", translation: "Para que no destiña." } },
      ...
      pitfalls: [
        ...
        { mistake: "“The shirt destains.”", whyItFails: "Destain no es el verbo cotidiano para una prenda que suelta color. La imagen natural es que el color runs o bleeds.", sayInstead: "The colour runs." }
      ],
      variations: [
  ...
  },
  {
    ...
    es: {
      ...
      setting: {
        ...
        where: "Pereira, in a neighbourhood workshop near the busier part of town, with toolboxes on the floor and radios playing quietly.",
      ...
      address: {
        form: "vos",
        who: "Lina and Jhon are about the same age and slip into vos because the workshop feels neighbourhood-familiar rather than corporate.",
        ...
        ifYouSwitch: "Usted would also work and would be safer with an older technician. Tú would be understood, but it would flatten a local flavour that is natural in this scene."
      },
      dialogue: [
      ...
      answer: 2,
      practiceExtra: [
        { prompt: "In a workshop, what does “¿en cuánto me lo arregla?” usually ask?", choices: ["The colour of the replacement item.", "The price for fixing the item.", "The address of the customer's house."], answer: 1, tests: "en cuánto as a repair price question" },
