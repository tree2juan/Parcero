...
lessons.push(
  {
    ...
    en: {
      ...
      vocabulary: [
        dl53Vocab("agree on", "Acordar un punto concreto: precio, fecha, hora, regla o condición.", "estar de acuerdo en", "Úselo cuando varias personas fijan el tema o término compartido.", "Evítelo para memoria. Acordarse de algo es remember, no agree on.", "neutro", "Inglés universal.", ["settle on", "decide on", "arrange", "set"], "We agreed on Friday.", "Acordamos el viernes."),
        dl53Vocab("agree with", "Estar de acuerdo con una persona, idea, opinión o preferencia.", "estar de acuerdo con", "Úselo cuando su postura coincide con la de alguien o algo.", "Evítelo para fijar una cita si el punto central es el arreglo. Agree on is clearer.", "neutro", "Inglés universal.", ["share the view", "support", "accept", "concur"], "I agree with you.", "Estoy de acuerdo con usted."),
        dl53Vocab("arrange", "Organizar o acordar detalles prácticos de una cita, reparación o plan.", "arreglar / organizar", "Úselo cuando la logística importa más que la idea de coincidir.", "Evítelo si sólo expresa opinión. Arrange with your color no tiene sentido.", "neutro", "Inglés universal.", ["set up", "schedule", "organize", "coordinate"], "We arranged the repair for Friday.", "Acordamos el arreglo para el viernes."),
        dl53Vocab("remember", "Recordar o acordarse de algo. Traduce la memoria, no el acuerdo.", "recordar", "Úselo para cumpleaños, herramientas, nombres, tareas o instrucciones que no quiere olvidar.", "Evítelo para acuerdos de precio o fecha. Remember a price can mean recordarlo, not agree it.", "neutro", "Inglés universal.", ["recall", "not forget", "keep in mind", "think of"], "I remembered your birthday.", "Me acordé de tu cumpleaños."),
        dl53Vocab("agreement", "Acuerdo como sustantivo: los términos o el entendimiento compartido.", "acuerdo", "Úselo para resumir lo pactado o hablar de un trato completo.", "Evítelo si todavía sólo están conversando sin cerrar nada.", "neutro", "Inglés universal.", ["deal", "arrangement", "understanding", "terms"], "That is the agreement.", "Ese es el acuerdo."),
        dl53Vocab("settle on", "Quedar en algo o decidirse por una opción después de revisar posibilidades.", "quedar en", "Úselo para fecha, lugar, precio u opción final.", "Evítelo si hubo un contrato formal con mucho detalle; agreement puede sonar más completo.", "neutro conversacional", "Inglés universal.", ["agree on", "choose", "land on", "decide on"], "We settled on Friday at eight.", "Quedamos en viernes a las ocho."),
        dl53Vocab("terms", "Condiciones o puntos de un acuerdo: precio, fecha, pago, alcance y materiales.", "términos", "Úselo cuando quiere que el arreglo quede claro y no dependa de memoria.", "Evítelo para una opinión sencilla, donde terms suena demasiado contractual.", "neutro práctico", "Inglés universal.", ["conditions", "details", "price", "schedule"], "Let's confirm the terms.", "Confirmemos las condiciones.")
      ],
      note:
      ...
      variations: [
        dl53Variation("We agreed on Friday.", "neutro", "Inglés universal", "Fijaron una fecha."),
        dl53Variation("I agree with you.", "neutro", "Inglés universal", "Coincide con una persona u opinión."),
        dl53Variation("We arranged the repair for Friday.", "práctico", "Inglés universal", "Organizaron la reparación."),
        dl53Variation("I remembered your birthday.", "cálido conversacional", "Inglés universal", "Se acordó del cumpleaños."),
        dl53Variation("Let's confirm the terms.", "práctico cortés", "Inglés universal", "Quieren dejar claro precio, fecha y condiciones."),
        {
  ...
  },
  {
    ...
    en: {
      ...
      vocabulary: [
        dl53Vocab("turn thirty", "Cumplir treinta. Turn más el número es la forma natural para llegar a una edad.", "girar treinta", "Úselo con edades: turn eighteen, turn thirty, turn sixty.", "Evítelo para la fiesta misma. Have a birthday or celebrate a birthday names the event.", "neutro", "Inglés universal.", ["turn eighteen", "turn forty", "age", "birthday"], "I'm turning thirty today.", "Hoy cumplo treinta."),
        dl53Vocab("have a birthday", "Cumplir años o tener cumpleaños, sin decir necesariamente la edad.", "tener un cumpleaños", "Úselo cuando importa el día, la celebración o felicitar a alguien.", "Evítelo si necesita la edad exacta. Then use turn plus the number.", "neutro cálido", "Inglés universal.", ["birthday", "celebrate", "party", "turn"], "She has a birthday today.", "Ella cumple años hoy."),
        dl53Vocab("meet a deadline", "Cumplir con un plazo. Meet encaja con deadlines, requirements y expectations.", "encontrar un plazo", "Úselo cuando una fecha límite o condición debe cumplirse.", "Evítelo para promesas personales, donde keep a promise suele sonar más natural.", "neutro práctico", "Inglés universal.", ["meet a requirement", "be on time", "deliver", "comply"], "We need to meet the deadline.", "Tenemos que cumplir con el plazo."),
        dl53Vocab("meet the time", "Cumplir con la hora acordada, especialmente en una coordinación práctica.", "encontrar la hora", "Úselo cuando el horario pactado importa y hay que respetarlo.", "Evítelo si habla de la edad de cumpleaños. Time here is schedule, not years.", "neutro práctico", "Inglés universal.", ["be on time", "stick to the time", "keep the time", "arrive on time"], "Meet the time we agreed on.", "Cumpla con la hora acordada."),
        dl53Vocab("keep a promise", "Cumplir una promesa. Es la colocación más natural en conversación.", "guardar una promesa", "Úselo para hacer lo prometido y no quedar mal.", "Evítelo como fulfill a promise si busca habla cotidiana; se entiende, pero suena más formal.", "neutro serio", "Inglés universal.", ["keep your word", "follow through", "come through", "not break it"], "Keep your promise to bring the cake.", "Cumpla la promesa de traer la torta."),
        dl53Vocab("keep your word", "Cumplir la palabra. Suena más personal y ético que simplemente terminar una tarea.", "guardar su palabra", "Úselo cuando la confianza de alguien está en juego.", "Evítelo para una regla impersonal. Meet a requirement puede ser más exacto.", "serio personal", "Inglés universal.", ["keep a promise", "honor your word", "follow through", "be reliable"], "Keeping your word takes work.", "Cumplir la palabra cuesta."),
        dl53Vocab("without fail", "Sin falta. Refuerza una hora, entrega o promesa.", "sin falla", "Úselo cuando quiere sonar firme sobre tiempo o cumplimiento.", "Evítelo si no puede controlar el resultado. Without fail raises the expectation.", "firme práctico", "Inglés universal.", ["for sure", "no later than", "definitely", "on time"], "At five, without fail.", "A las cinco, sin falta.")
      ],
      note:
      ...
      variations: [
        dl53Variation("Today I turn thirty.", "cálido neutro", "Inglés universal", "Cumple treinta hoy."),
        dl53Variation("When is your birthday?", "neutro", "Inglés universal", "Pregunta cuándo cumple años alguien."),
        dl53Variation("We need to meet the deadline.", "práctico", "Inglés universal", "Hay que cumplir con un plazo."),
        dl53Variation("I'll keep my promise.", "serio personal", "Inglés universal", "Promete cumplir la palabra."),
        dl53Variation("At five, without fail.", "firme práctico", "Inglés universal", "Quiere sonar puntual y confiable.")
      ],
  ...
  },
  {
    ...
    en: {
      ...
      vocabulary: [
        ...
        dl53Vocab("insist on", "Insistir en o exigir con firmeza. Puede sonar menos agresivo que demand.", "insistir en", "Úselo para una condición razonable que no quiere dejar caer.", "Evítelo si sólo está preguntando por una opción. Request or ask for is lighter.", "firme neutro", "Inglés universal.", ["demand", "stand firm on", "require", "press for"], "I insist on a written response.", "Exijo una respuesta por escrito."),
        dl53Vocab("request", "Solicitar o pedir formalmente. Es más tranquilo que demand.", "solicitar", "Úselo para formularios, reembolsos, documentos, citas y procedimientos.", "Evítelo si necesita mostrar que le están negando un derecho. Puede sonar demasiado suave.", "formal neutro", "Inglés universal.", ["ask for", "apply for", "seek", "submit"], "I request a refund.", "Solicito devolución."),
        dl53Vocab("refund", "Devolución de dinero o reembolso.", "reembolso", "Úselo cuando el dinero debe volver porque el producto o servicio falló.", "Evítelo para una explicación o disculpa sin dinero. Refund is specifically money.", "neutro consumer", "Inglés universal.", ["money back", "reimbursement", "return", "repayment"], "I want a full refund.", "Quiero devolución total."),
        dl53Vocab("written response", "Respuesta por escrito. Hace que el reclamo quede verificable.", "respuesta escrita", "Úselo cuando necesita constancia, seguimiento o una prueba de lo dicho.", "Evítelo si sólo necesita una orientación rápida en el mostrador.", "formal práctico", "Inglés universal.", ["record", "email response", "written answer", "confirmation"], "I need a written response.", "Necesito respuesta por escrito."),
        ...
        dl53Vocab("assert your rights", "Hacer valer sus derechos. Firme, claro y menos explosivo que sólo demandar.", "afirmar sus derechos", "Úselo cuando tiene una base legal, contractual o de consumidor y quiere actuar con control.", "Evítelo para preferencias pequeñas sin derecho detrás. Rights makes the claim bigger.", "formal cívico", "Inglés universal.", ["stand up for your rights", "exercise your rights", "make a claim", "file a complaint"], "Assert your rights without shouting.", "Haga valer sus derechos sin gritar.")
      ],
      note:
      ...
      variations: [
        ...
        dl53Variation("I insist on a written response.", "firme neutro", "Inglés universal", "Quiere firmeza sin sonar explosivo."),
        dl53Variation("I request a full refund.", "formal consumer", "Inglés universal", "Pide devolución por vía formal."),
        dl53Variation("Please give me the complaint form.", "cortés formal", "Inglés universal", "Pide el mecanismo de reclamo sin gritar."),
        dl53Variation("I want to assert my rights.", "formal cívico", "Inglés universal", "Fundamenta la insistencia en derechos."),
        {
