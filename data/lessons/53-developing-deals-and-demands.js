...
lessons.push(
  {
    ...
    es: {
      ...
      setting: {
        ...
        where: "Ibagué, in a residential neighbourhood, using plain Colombian Spanish in a city not overused by the course.",
      ...
      dialogue: [
        ...
        dl53Dialogue("Don Rubén", "Y si después no está de acuerdo con el color, lo hablamos antes de pintar.", "And if later you don't agree with the colour, we'll talk before painting.", "ee see des-PWES noh es-TAH deh ah-KWER-doh kon el koh-LOR, loh ah-BLAH-mos AN-tes deh peen-TAR", "And if later you are-not of agreement with the colour, it we-talk before painting.", "Estar de acuerdo is agreement with an opinion or preference. Acordar sets the plan; estar de acuerdo says the view or choice suits you.")
      ],
      vocabulary: [
    ...
    en: {
      ...
      vocabulary: [
        ...
        dl53Vocab("arrange", "Organizar o acordar detalles prácticos de una cita, reparación o plan.", "arreglar / organizar", "Úselo cuando la logística importa más que la idea de coincidir.", "Evítelo si sólo expresa opinión. Arrange with your colour no tiene sentido.", "neutral", "Inglés universal.", ["set up", "schedule", "organise", "coordinate"], "We arranged the repair for Friday.", "Acordamos el arreglo para el viernes."),
  ...
  },
  {
    ...
    es: {
      ...
      setting: {
        ...
        where: "Montería, at a family patio before a birthday meal, with general Colombian Spanish and no invented local colouring.",
    ...
    en: {
      title: "Cumplir años en Vancouver",
      situation:
        "Usted está en Vancouver organizando un cumpleaños familiar. En inglés debe separar turn thirty, have a birthday, meet a deadline y keep a promise, porque cumplir cambia según el sustantivo.",
      setting: {
        ...
        where: "Vancouver, en el patio de una casa familiar, porque esta dirección practica inglés fuera de Colombia.",
      ...
      vocabulary: [
        ...
        dl53Vocab("keep your word", "Cumplir la palabra. Suena más personal y ético que simplemente terminar una tarea.", "guardar su palabra", "Úselo cuando la confianza de alguien está en juego.", "Evítelo para una regla impersonal. Meet a requirement puede ser más exacto.", "serious personal", "Inglés universal.", ["keep a promise", "honour your word", "follow through", "be reliable"], "Keeping your word takes work.", "Cumplir la palabra cuesta."),
