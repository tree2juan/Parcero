...
const structureItems = [
  ...
  {
    id: "structure-5",
    key: "colour-and-description",
    probe: "rojo|roja|azul|verde|amarill|negro|negra|blanc|caf[eé]|naranja|morad|gris|rosad",
    name: "Colours and describing what things look like",
    example: "La camisa azul, no la verde, la de rayas.",
    english: "colours and appearance",
    level: "foundation",
    summary: "Colour adjectives and their agreement, the invariable ones (naranja, rosa, violeta), café for brown rather than marrón in Colombia, and describing by pattern and material when you do not know the word.",
    gap: "18 colour words across 208 lessons",
    skills: ["grammar", "speaking", "context"],
    domain: "shopping",
    pathways: ["foundation", "year-12"],
    reviewStatus: "needs Colombian Spanish and English education review"
